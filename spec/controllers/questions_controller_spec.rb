...
let(:my_question) do
  ...
  describe "POST create" do
    ...
    it "increases the number of question by 1" do
      expect{ post :create, {question: {title: "title", body: "body", result: false}}}.to change(Question,:count).by(1)
    end
  ...
  describe "PUT update" do
    ...
    it "updates question with expected attributes" do
      ...
      put :update, id: my_question.id, question: { title: new_title, body: new_body, result: false }
    ...
    it "redirects to the updated question" do
      ...
      put :update, id: my_question.id, question: {title: new_title, body: new_body, result: true}
